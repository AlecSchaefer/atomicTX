...
const EthEscrow = utils.EthEscrow
const ERC20Escrow = utils.ERC20Escrow
const ERC721Escrow = utils.ERC721Escrow
...
contract('EthEscrowPositiveTests', async function (accounts) {

  beforeEach('Make fresh contract', async function () {
    escrow = await EthEscrow.new( // We let accounts[5] represent the minter.
